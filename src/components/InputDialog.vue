    ...
    <Dialog class="t-relative t-z-10" @close="$emit('close')">
      ...
      <div class="t-fixed t-inset-0 t-z-10 t-w-screen t-overflow-y-auto t-h-screen">
        ...
        >
          ...
          >
            <DialogPanel
              class="t-relative t-transform t-overflow-y-auto t-rounded-lg t-bg-white dark:t-bg-gray-900 t-px-4 t-pb-4 t-pt-5 t-text-left t-shadow-xl t-transition-all sm:t-my-8 t-w-full t-max-w-md sm:t-max-w-lg sm:t-p-6"
            >
              <div>
                <div>
                  <DialogTitle
