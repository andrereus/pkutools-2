  ...
  <div>
    <v-row justify="center">
      <v-col cols="12" md="10" lg="8" xl="6">
        ...
        <p>
          In no event shall the Company be liable for any special, direct, indirect, consequential,
          ...
          the contents of the Service. The Company reserves the right to make additions, deletions,
        ...
        <p>
          Individuals are different and may react differently to different products. Comments made
          on the Service by employees or other users are strictly their own personal views made in
          their own personal capacity and are not claims made by the Company nor do they represent
          the position or view of the Company.
        </p>
        <p>
        ...
        <p>
          ...
          The Company is not responsible for any damages for information or services provided even
        ...
        <p>
          ...
          or in any way affiliated with the Company.
        </p>
        <p>
        ...
        <p>
          ...
          Even if the Company takes every precaution to ensure that the content of the Service is
          both current and accurate, errors can occur. Plus, given the changing nature of laws,
          rules and regulations, there may be delays, omissions or inaccuracies in the information
        ...
        <p>
          ...
          something written in or as a direct result of something written in a comment. The Company
          is not liable for any comment published by users and reserves the right to delete any
...
export default {
  metaInfo() {
    return {
      ...
      meta: [{ name: 'description', content: this.$t('disclaimer.description') }]
    }
  },
  data: () => ({
    part1: 'mail',
